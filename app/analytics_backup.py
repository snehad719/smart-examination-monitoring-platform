...
def generate_integrity_scores():
    ...
    for session_id in sessions["id"]:
        try:
            ...
            # Skip sessions with invalid timing/data
            continue
...
def plot_event_frequency_heatmap():
    ...
    # Keep missing session IDs as Unknown.
    # We do not invent session IDs.
...
def perform_kmeans_clustering(df):
    ...
    # K-Means requires at least 2 samples
    ...
    # Keep existing project configuration:
    number_of_clusters = 2

    # Cannot have more clusters than sessions
...
if __name__ == "__main__":
    ...
    # --------------------------------------------------------
    # Generate integrity scores for ALL valid sessions
    # --------------------------------------------------------
